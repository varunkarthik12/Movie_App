...
const Bookmark = () => {
          ...
          const bookmarkList : MovieDataType[] = movies.filter(movie => movie.isBookmarked)
    
    
          const handleSearch = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement, Element>) => {
    
              setSearch(event.target.value);
              const newList = movies.filter( (movies) => movies.title.toLowerCase().includes(search.toLowerCase()) && movies.isBookmarked);
                      ...
                      <Box sx = {{
                        width : "100"
                          ...
                          <Box sx = {{width : "100"}}>
                              ...
                              <MovieList recommendList = {bookmarkList}></MovieList>
                          </Box>
