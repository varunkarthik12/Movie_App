...
const TvSeries = () => {
          ...
          const tvSeriesList : MovieDataType[] = movies.filter(movie => movie.category === "TV Series")
    
    
          const handleSearch = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement, Element>) => {
    
              setSearch(event.target.value);
              const newList = movies.filter( (movies) => movies.title.toLowerCase().includes(search.toLowerCase()) && movies.category === "TV Series");
                      ...
                      <Box sx = {{
                        width : "100"
                          ...
                          <Box sx = {{width : "100"}}>
                              ...
                              <MovieList recommendList = {tvSeriesList}></MovieList>
                          </Box>
