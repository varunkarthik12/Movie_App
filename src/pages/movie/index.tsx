...
const Movie = () => {
      ...
      const movieList : MovieDataType[] = movies.filter(movie => movie.category === "Movie")


      const handleSearch = (event: ChangeEvent<HTMLInputElement | HTMLTextAreaElement, Element>) => {

          setSearch(event.target.value);
          const newList = movies.filter( (movies) => movies.title.toLowerCase().includes(search.toLowerCase()) && movies.category === "Movie");
                  ...
                  <Box sx = {{
                    width : "100"
                      ...
                      <Box sx = {{width : "100"}}>
                          ...
                          <MovieList recommendList = {movieList}></MovieList>
                      </Box>
